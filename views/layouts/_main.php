...
<body>
	...
	<div id="main">
		...
		<div id="navigation">
            ...
            <div class="cell"><?=Html::a('СТАТЬИ', ['post/articles'], ['class' => 'cell_a'])?></div>
            <div class="cell"><?=Html::a('О МАГАЗИНЕ', ['post/about-mag'], ['class' => 'cell_a'])?></div>
            <div class="cell"><?=Html::a('КОНТАКТЫ', ['post/contacts'], ['class' => 'cell_a'])?></div>
            <div class="cell"><?=Html::a('ДОСТАВКА И ОПЛАТА', ['post/deliviry'], ['class' => 'cell_a'])?></div>
            <div class="cell"><?=Html::a('КАТАЛОГ', ['post/catalog'], ['class' => 'cell_a'])?></div>
            <div class="cell"><?=Html::a('<span class="glyphicon glyphicon-log-in"></span>Log in', ['/admin/'], ['class' => 'cell_a'])?></div>
