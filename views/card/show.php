    ...
    <div id="total">
        ...
        foreach ($goods as $id => $good) {
            ...
            <tr>
                ...
                <td><button class="del_product" data-id="<?=$good->id?>"><span class="glyphicon glyphicon-remove"></span></button></td>
            </tr>
       ...
       <?php } ?>
        ...
        <a href="/card/clear?show=1"><button type="button" class="btn btn-primary">Очистить корзину</button> </a>
